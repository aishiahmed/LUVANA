...
<nav>
    <a href="dashboard.php" class="logo">LUVANA</a>
...
<section class="hero">
    ...
    <div class="hero-buttons">
        ...
        <a href="mood_suggestion.php" class="hero-btn secondary">Find Soap by Mood</a>
    </div>
</section>
...
<section class="transition-area">
    ...
    <div class="transition-buttons">
        ...
        <a href="mood_suggestion.php" class="btn-mood">Get Mood Suggestion</a>
    </div>
</section>
