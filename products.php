...
<head>
    ...
    <style>
        ...
        .nav-left { display: flex; align-items: center; gap: 10px; text-decoration: none; color: var(--earth); font-weight: bold; }
        .nav-logo { font-family: 'Playfair Display', serif; font-weight: bold; font-size: 1.5em; color: var(--earth); text-decoration: none; }
        .logout-btn { 
        ...
        .card { background: white; border-radius: 20px; width: 320px; overflow: hidden; box-shadow: 0 10px 20px rgba(0,0,0,0.05); transition: 0.3s; padding-bottom: 20px; border: 1px solid #f0f0f0; position: relative; }
        .card.highlight { border: 3px solid var(--sage); transform: scale(1.05); box-shadow: 0 15px 30px rgba(138, 154, 91, 0.3); z-index: 10; }
        ...
        .btn { padding: 12px; border-radius: 30px; border: none; font-weight: bold; cursor: pointer; transition: 0.3s; font-size: 14px; width: 100%; }
        ...
        .qty-input { width: 90%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; font-family: inherit; }
    </style>
</head>
<body>
    ...
    <nav class="navbar">
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
            <a href="cart.php" style="text-decoration: none; color: var(--earth); font-weight: bold;">View Cart</a>
